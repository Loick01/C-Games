...
C-Games est une compilation de 5 mini-jeux, écrits en C avec la librairie SDL2. Il s'agit d'un projet assez simpliste, mon but étant de prendre en main la librairie SDL2 dans le cadre de mon stage de fin de licence.
...
Le menu ci-dessous va alors s'ouvrir, vous permettant de sélectionner le mini-jeu auquel vous souhaitez jouer.
